...
struct Z_Construct_UClass_ASnake_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_IA_Secondary_Horizontal_MetaData[] = {
		{ "Category", "Input" },
		{ "ModuleRelativePath", "Snake.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_IA_Secondary_Vertical_MetaData[] = {
		{ "Category", "Input" },
		{ "ModuleRelativePath", "Snake.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_IA_Secondary_Horizontal;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_IA_Secondary_Vertical;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASnake_Statics::NewProp_IA_Secondary_Horizontal = { "IA_Secondary_Horizontal", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASnake, IA_Secondary_Horizontal), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IA_Secondary_Horizontal_MetaData), NewProp_IA_Secondary_Horizontal_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASnake_Statics::NewProp_IA_Secondary_Vertical = { "IA_Secondary_Vertical", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASnake, IA_Secondary_Vertical), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IA_Secondary_Vertical_MetaData), NewProp_IA_Secondary_Vertical_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASnake_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASnake_Statics::NewProp_IA_Secondary_Horizontal,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASnake_Statics::NewProp_IA_Secondary_Vertical,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_AntonLanning_Documents_Unreal_Projects_SnakeGAME_snakers_Source_snakers_Snake_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASnake, ASnake::StaticClass, TEXT("ASnake"), &Z_Registration_Info_UClass_ASnake, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASnake), 3710045020U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_AntonLanning_Documents_Unreal_Projects_SnakeGAME_snakers_Source_snakers_Snake_h_2173160732(TEXT("/Script/snakers"),
	Z_CompiledInDeferFile_FID_Users_AntonLanning_Documents_Unreal_Projects_SnakeGAME_snakers_Source_snakers_Snake_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_AntonLanning_Documents_Unreal_Projects_SnakeGAME_snakers_Source_snakers_Snake_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
